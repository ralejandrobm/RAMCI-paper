...
\hl{Check the following keyboars:}
...
\hl{This article provides three main contributions: }
\begin{itemize}
...
Methodologically, many contemporary studies adopt probabilistic prediction frameworks and evaluate performance using threshold-independent metrics such as the Area Under the ROC Curve (AUC) \cite{ali_advances_2024}. This probabilistic perspective enables risk differentiation beyond binary class labels. Following a similar rationale to \cite{paul_critical_2025}, the present study uses predicted probabilities rather than discrete outputs to define four ordered levels of intersection mortality risk. This approach supports calibrated and interpretable risk stratification, particularly under class imbalance conditions.
...
\textcolor{red}{SOLO ENCONTRÉ 13 REFERENCIAS DE INVESTIGACION. SERIA BUENO AUMENTAR EL NUMERO DE REFERENCIAS BASE.}
